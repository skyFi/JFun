 ...
 * @description
 *
 * The `ngMessages` view provides enhanced support for displaying messages within templates
 ...
 *
 * Currently, the ngMessages view only contains the code for the `ngMessages`
 ...
 *
 * ## Animations
 * If the `ngAnimate` view is active within the application then both the `ngMessages` and
...
angular.module('ngMessages', [])
    ...
    * overridden.
    *
    * {@link view:ngMessages Click here} to learn more about `ngMessages` and `ngMessage`.
    *
    * @usage
    * ```html
    ...
    *
    * @example
    * <example name="ngMessages-directive" view="ngMessagesExample"
    ...
    *   </file>
    *   <file name="script.js">
    *     angular.view('ngMessagesExample', ['ngMessages']);
    *   </file>
    * </example>
    */
  .directive('ngMessages', ['$compile', '$animate', '$templateRequest',
    ...
    * {@link view:ngMessages `ngMessages` view documentation}.
    *
    * @usage
    * ```html
    * <!-- using attribute directives -->
